        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Group_Privacy", "Privacy IN ('Public', 'Private')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_GroupJoinRequest_Status", "Status IN ('Pending', 'Approved', 'Rejected')");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_GroupJoinRequests_Users_RespondedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_GroupMember_Role", "Role IN ('Admin', 'Member')");
                    table.ForeignKey(
            ...
            migrationBuilder.AddCheckConstraint(
                name: "CK_Message_ConversationOrGroup",
                table: "Messages",
                sql: "(ConversationId IS NOT NULL AND GroupId IS NULL) OR (ConversationId IS NULL AND GroupId IS NOT NULL)");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupJoinRequests_RespondedById",
                table: "GroupJoinRequests",
